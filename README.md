# TSM AGRO - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **TSM AGRO**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@tsmagro.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@tsmagro.cm` | `user123` | |
